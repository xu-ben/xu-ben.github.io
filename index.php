		...
		<section class="item-wrap">
			...
			<section class="item-box-right" style="margin-bottom: 10px;">
				<table style="margin-bottom: 10px; border-bottom: dashed 1px #ccc;">
					...
					<tr>
						<td class="item-content">&nbsp;&nbsp;&nbsp;&nbsp; 2016.05 - 2018.03 担任嵌入式软件工程师职务，负责公司嵌入式平台代理组件的研发与维护，平台P2P通信相关模块的技术选型、实现及维护。2018.04 起担任系统架构师职务，负责公司核心平台组件的研发与维护。在职期间为公司申请软件著作权两项：安元网络应用设备终端开发包C++版，登记号2016R11L709784；安元网络应用设备终端开发包Java版，登记号2016R11L709802。
						</td>
					</tr>
				</table>
			</section>
